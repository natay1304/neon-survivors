...
export const WEAPONS: Record<string, WeaponDef> = {
  magic_orb: {
    ...
    icon: '🔮',
    levels: [
      { damage: 25, cooldown: 0.47, count: 1, speed: 380, pierce: 1, size: 8, knockback: 40 },
      { damage: 25, cooldown: 0.55, count: 1, speed: 400, pierce: 1, size: 9, knockback: 35 },
      { damage: 30, cooldown: 0.51, count: 2, speed: 420, pierce: 1, size: 10, knockback: 40 },
      { damage: 35, cooldown: 0.43, count: 2, speed: 440, pierce: 2, size: 11, knockback: 45 },
      { damage: 45, cooldown: 0.34, count: 3, speed: 470, pierce: 2, size: 12, knockback: 50 },
    ],
  },
  holy_aura: {
    name: 'Holy Aura',
    ...
    icon: '✨',
    levels: [
      { damage: 8,  cooldown: 0.43, count: 1, speed: 0, pierce: 99, size: 80,  knockback: 20 },
      { damage: 12, cooldown: 0.38, count: 1, speed: 0, pierce: 99, size: 100, knockback: 25 },
      { damage: 16, cooldown: 0.34, count: 1, speed: 0, pierce: 99, size: 120, knockback: 30 },
      { damage: 22, cooldown: 0.30, count: 1, speed: 0, pierce: 99, size: 145, knockback: 35 },
      { damage: 30, cooldown: 0.26, count: 1, speed: 0, pierce: 99, size: 170, knockback: 40 },
    ],
  },
  lightning: {
    name: 'Lightning',
    ...
    levels: [
      ...
      { damage: 70, cooldown: 0.94, count: 2, speed: 0, pierce: 1, size: 400, knockback: 0 },
      { damage: 90, cooldown: 0.77, count: 2, speed: 0, pierce: 1, size: 450, knockback: 0 },
      { damage: 120, cooldown: 0.60, count: 3, speed: 0, pierce: 1, size: 500, knockback: 0 },
    ],
  },
  frost_nova: {
    name: 'Frost Nova',
    ...
    icon: '❄️',
    levels: [
      { damage: 25, cooldown: 2.13, count: 1, speed: 0, pierce: 99, size: 120, knockback: 80 },
      { damage: 35, cooldown: 1.87, count: 1, speed: 0, pierce: 99, size: 150, knockback: 100 },
      { damage: 45, cooldown: 1.62, count: 1, speed: 0, pierce: 99, size: 180, knockback: 120 },
      { damage: 60, cooldown: 1.36, count: 1, speed: 0, pierce: 99, size: 210, knockback: 140 },
      { damage: 80, cooldown: 1.11, count: 1, speed: 0, pierce: 99, size: 250, knockback: 160 },
    ],
  },
  fire_trail: {
    name: 'Fire Trail',
    ...
    icon: '🔥',
    levels: [
      { damage: 15, cooldown: 0.17, count: 1, speed: 0, pierce: 99, size: 18, knockback: 0 },
      { damage: 20, cooldown: 0.15, count: 1, speed: 0, pierce: 99, size: 22, knockback: 0 },
      { damage: 28, cooldown: 0.13, count: 1, speed: 0, pierce: 99, size: 26, knockback: 0 },
      { damage: 38, cooldown: 0.10, count: 1, speed: 0, pierce: 99, size: 30, knockback: 0 },
      { damage: 50, cooldown: 0.09, count: 1, speed: 0, pierce: 99, size: 36, knockback: 0 },
    ],
  },
};
